...
def get_generated_user_input(user_question):
    ...
    prompt="You are a AI assistant for the Canadian University Dubai, this is the information given to you answering the user question, return this answer but make it worded more helpful do not add anything that is not mentioned in the response. information:\n{response}\n question:\n{user_question}\n "
...
def main():
    ...
    for message in st.session_state.chat_history:
        ...
        if avatar:
            ...
            with st.chat_message(message.role, avatar=avatar):
                # Check if the message has 'Canadian University Dubai' in its parts
    ...
    if user_question is not None and user_question.strip() != "":
        ...
        response=get_generated_user_input(user_question)
