...
model = GoogleGenerativeAI(temperature=0.7,
            model="gemini-pro",
...
class TextClusterSummarizer:
    def __init__(
        ...
        self.embedding_model = GoogleGenerativeAIEmbeddings(model="models/embedding-001",google_api_key=os.environ["api_key"])
        self.chat_model = GoogleGenerativeAI(temperature=0.2,
            model="gemini-pro",
            google_api_key=os.environ["api_key"],
